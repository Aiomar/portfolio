...
const Resume = forwardRef(({ id, visible }, ref) => {
  ...
  return (
    <section
      id={id}
      ref={ref}
      className="flex flex-col items-center bg-slate-100 dark:bg-gray-950w-full h-screen"
    >
      ...
      {toggleTechStack && !toggleEducation && !toggleExperience ? (
        <div className="flex md:flex-col  items-center bg-slate-100 dark:bg-gray-950w-full h-fit">
          <motion.div
            ref={ref}
        ...
        <div
          id="Experience"
          className="flex flex-col items-center bg-gray-100 dark:bg-gray-950w-full h-screen"
        >
          <motion.div
            ref={ref}
            variants={motionVariants}
