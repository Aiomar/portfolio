...
export default function Contact() {
  ...
  return (
    <section
      id="Contact"
      className="flex flex-col items-center bg-slate-100 dark:bg-gray-900 w-full h-fit md:h-screen"
    >
      <div className="mb-5 md:mb-16 mt-5">
        <h5 className="font-mono ml-5 mt-24 md:mt-28 text-5xl  font-bold tracking-tight text-gray-900 dark:text-white">
          <div className="flex roboto-regular">Contact me</div>
        </h5>
      </div>
      <motion.div
        ref={ref}
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:justify-center mb-5">
          {/*Github Card */}
          <div>
            <Social
              name="omar aidi"
